...
const generateOneRecord = () => {
  const oneRecord = {
    product_description:  faker.lorem.sentence(20),
    feature1_title:       faker.lorem.word(),
    feature1_description: faker.lorem.words(7),
    feature2_title:       faker.lorem.word(),
    feature2_description: faker.lorem.words(12),
    feature3_title:       faker.lorem.word(),
    feature3_description: faker.lorem.words(),
    feature4_title:       faker.lorem.word(),
    feature4_description: faker.lorem.words(),
    feature5_title:       faker.lorem.word(),
    feature5_description: faker.lorem.words(),
    feature6_title:       faker.lorem.word(),
    feature6_description: faker.lorem.words(),
...
const testRecord = generateOneRecord();
console.log('ONE RECORD: ', testRecord);